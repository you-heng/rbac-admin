...
class RbacTeamTable extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('team', ['engine' => 'MyISAM', 'collation' => 'utf8_unicode_ci', 'comment' => '' ,'id' => 'id' ,'primary_key' => ['id']]);
        $table->addColumn('team_name', 'string', ['limit' => 20,'null' => false,'default' => null,'signed' => true,'comment' => '部门名称',])
